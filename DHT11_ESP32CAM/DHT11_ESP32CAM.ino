/*Código Utilizado para fines educativos en el Curso de IoT
 * Utilizado y editado por : Miguel Angel Peralta Martínez
 * Fecha de edición final: 18 de agosto del 2022
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    String json = "{\"id\":\"MiguelP\",\"temp\":"+String(t)+",\"hum\":"+String(h)+"}";
